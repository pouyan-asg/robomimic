"""
ME: I modified to be simpler only for BC training.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default='/home/pouyan/phd/imitation_learning/robomimic/robomimic/exps/templates/bc.json',
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default='/home/pouyan/phd/imitation_learning/robomimic/robomimic/datasets/lift/ph/low_dim_v15.hdf5',
